...
We can see from the variable importance plots that boosting does not
quite align with other models. For instance, GDP growth is not as important in other models
whereas it is second most important in boosting model. This is a crucial distinction
as seen from the models' performances.
...
### Model Performances
Based on the model performances, we can see that XGBoost performs the best out of 
all the models. All the models' MSE are actually quite close to each other except for
boosting. And the key difference between boosting and other models are as discussed above.
...
# PDF Report Download
Click [here](https://hgeorge21.github.io/JSC370-actualfinalproject/resource/report.pdf) to download report
